...
import pt.up.fe.ddsfl.common.messaging.Message.ByeMessage;
import pt.up.fe.ddsfl.common.messaging.Message.EndTransactionMessage;
import pt.up.fe.ddsfl.common.messaging.Message.HandshakeMessage;
...
public class Client implements EventListener {
    ...
    public void addNode(int id, String name, Node.Type type, int parentId, int line) {
        postMessage(new AddNodeMessage(id, name, type, parentId, line));
    }
