...
import pt.up.fe.qsfl.common.events.NullEventListener;
import pt.up.fe.qsfl.common.messaging.Client;
...
import pt.up.fe.qsfl.instrumenter.matchers.ClassNamesMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.DuplicateCollectorReferenceMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.FieldNameMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.InterfaceMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.Matcher;
import pt.up.fe.qsfl.instrumenter.matchers.ModifierMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.OrMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.PrefixMatcher;
import pt.up.fe.qsfl.instrumenter.matchers.WhiteList;
import pt.up.fe.qsfl.instrumenter.passes.FilterPass;
import pt.up.fe.qsfl.instrumenter.passes.InstrumentationPass;
import pt.up.fe.qsfl.instrumenter.passes.LandmarkInserterPass;
import pt.up.fe.qsfl.instrumenter.passes.ParameterDataPass;
import pt.up.fe.qsfl.instrumenter.passes.Pass;
import pt.up.fe.qsfl.instrumenter.passes.StackSizePass;
import pt.up.fe.qsfl.instrumenter.passes.TestFilterPass;
import pt.up.fe.qsfl.instrumenter.passes.VectorInitializationPass;
import pt.up.fe.qsfl.instrumenter.passes.Pass.Outcome;
...
public class AgentConfigs {
    ...
    public List<Pass> getInstrumentationPasses() {
        ...
        Collections.addAll(prefixes, "javax.", "java.", "sun.", "com.sun.", "pt.up.fe.qsfl.");
